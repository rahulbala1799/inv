        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mb-12">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur">
                ...
                <h3 className="text-lg mb-2">iOS</h3>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur">
                ...
                <h3 className="text-lg mb-2">Android</h3>
                <p className="text-sm text-gray-400">All devices</p>
              </div>
            </div>
          ...
          >
            <div className="relative max-w-sm mx-auto">
              ...
              />
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl flex items-center justify-center">
